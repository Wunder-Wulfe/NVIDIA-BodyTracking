...
public:
    ...
    inline bool SetConfigInteger(const char *section, const char *key, int value) { _itoa_s(value, m_tempBuffer, 10); m_iniFile.SetValue(section, key, m_tempBuffer); return true; }
    inline  bool SetConfigFloat(const char *section, const char *key, float value) { m_iniFile.SetDoubleValue(section, key, (double)value); return true; }
    ...
    inline bool SetConfigBoolean(const char *section, const char *key, bool value) { m_iniFile.SetBoolValue(section, key, value); return true; }
    inline bool SetConfigCString(const char *section, const char *key, const char *value) { m_iniFile.SetValue(section, key, value); return true; }
    inline bool SetConfigString(const char *section, const char *key, const std::string &value) { m_iniFile.SetValue(section, key, value.c_str()); return true; }
